...
export { mainContainer, title, mainSection, scoresDisplay, addScoresDisplay, headingDiv, subTitle, refreshButton, subTitle2, unorderedList, nameInput, scoreInput, submitButton, footer }